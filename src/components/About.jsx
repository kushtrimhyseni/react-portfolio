...
const About = () => {
  return (
    <div
      ...
      id="about"
    >
      <h1 className="text-3xl font-bold pb-5 relative text-blue-900 font-raleway p-6">
        About
      </h1>
      <p className="text-[#272829] font-raleway font-opensans text-base p-6">
        {about[0].aboutme}
      </p>
      <div className="flex flex-col lg:flex-row mt-0 lg:mt-6 p-6">
        <img
